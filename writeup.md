...
This writeup is structured so you can paste it into your GitHub `writeup.md`. Ensure any logs or samples you publish are sanitized (remove real IPs, hostnames, keys and flags) before making the repository public.

If you want, I can now:

* generate a polished `README.md` and `writeup.md` pair ready to commit (sanitized), or
* create example parsed outputs and a small `examples/` folder showing the exact `last`/`utmp.py` outputs to include in your repo.
